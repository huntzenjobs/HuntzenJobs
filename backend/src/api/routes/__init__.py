...
router.include_router(marketing_router, prefix="/api/marketing", tags=["Marketing Preferences"])
...
router.include_router(banner_router, prefix="/api", tags=["Banner & Maintenance"])
