-- Recherche textuelle bornée pour conserver les sources expatriation
-- lorsque le fournisseur d'embeddings est momentanément indisponible.

CREATE INDEX IF NOT EXISTS expat_chunks_content_fts_idx
    ON public.expat_chunks
