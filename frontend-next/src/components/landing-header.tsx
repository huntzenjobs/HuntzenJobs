    ...
    >
      <div className="container mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-6 xl:gap-8">
          <Link
            href="/jobs"
            className={`relative text-base font-bold transition-colors pb-1 group ${shouldBeWhite ? "text-gray-700 hover:text-black" : "text-white/90 hover:text-white"}`}
          >
            Recherche d&apos;emploi
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {user ? (
            ...
            <>
              <Link
                href="/login"
                className={`hidden md:inline-flex items-center px-4 lg:px-5 py-2 rounded-lg text-sm font-semibold transition-colors ${shouldBeWhite ? "text-gray-700 hover:text-[#00D9FF]" : "text-white hover:text-[#00D9FF]"}`}
              >
                CONNEXION
              </Link>
              <Link
        ...
        >
          <nav className="container mx-auto px-6 py-4 flex flex-col gap-4">
            <Link
              ...
              className={`relative text-base font-bold transition-colors py-2 group ${shouldBeWhite ? "text-gray-700 hover:text-black" : "text-white/90 hover:text-white"}`}
            >
              Recherche d&apos;emploi
              <span className="absolute bottom-0 left-0 w-0 h-1 bg-[#00D9FF] transition-all duration-300 group-hover:w-full"></span>
            </Link>
