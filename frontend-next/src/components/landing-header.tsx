    ...
    >
      <div className="container mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-6 xl:gap-8">
          <Link
            href="/jobs"
            className={`relative text-base font-bold transition-colors pb-1 group ${isScrolled ? "text-gray-700 hover:text-black" : "text-white/90 hover:text-white"}`}
          >
            Recherche d&apos;emploi
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {user ? (
            <Link href="/jobs">
              <div
                className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors ${isScrolled ? "bg-gray-100 hover:bg-gray-200" : "bg-white/10 hover:bg-white/20"}`}
              >
                <div className="w-7 h-7 rounded-full bg-[#00D9FF]/20 flex items-center justify-center">
                  <User className="w-4 h-4 text-[#00D9FF]" />
                </div>
                <span
                  className={`text-sm font-medium hidden md:inline ${isScrolled ? "text-black" : "text-white"}`}
                >
