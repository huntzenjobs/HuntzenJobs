...
export function SubscriptionCard() {
  ...
  return (
    <Card className={cn(
      "p-6 space-y-6",
      isPaidPlan && "border-2 border-gradient-to-r from-violet-500 to-purple-500"
    )}>
      {/* Plan Header */}
      ...
      <div className="space-y-3">
        <h3 className="font-semibold text-sm text-gray-700">Fonctionnalités incluses</h3>
          ...
          {features.map(({ key, label, enabled }) => (
            ...
            >
              {enabled ? (
                ...
                <X className="w-4 h-4 text-gray-400 shrink-0" aria-hidden="true" />
              )}
      ...
      <div className="space-y-4">
        <h3 className="font-semibold text-sm text-gray-700">Utilisation du jour</h3>
        ...
        {/* Job Searches */}
        <div className="space-y-1">
          <p className="text-xs text-gray-500 font-medium">Recherches d'emploi</p>
        ...
        <>
          ...
          <div className="bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200 rounded-lg p-4 space-y-3">
            <div className="flex items-start gap-3">
              <Crown className="w-5 h-5 text-violet-600 shrink-0 mt-0.5" aria-hidden="true" />
              <div className="space-y-1">
                <p className="font-semibold text-violet-900">
                  Débloquez tout le potentiel de HuntZen
                </p>
                <p className="text-sm text-violet-700">
                  Passez à un plan payant pour des analyses illimitées, plus de temps
                  de coaching, et des fonctionnalités exclusives.
                </p>
              </div>
            </div>
            <Button
