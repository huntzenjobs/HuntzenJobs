...
import { Lock, Sparkles, MapPin, Building, TrendingUp, Star } from 'lucide-react'
...
const SAMPLE_JOBS = [
  {
    ...
    salary: '55K - 75K EUR',
    description: 'Nous recherchons un développeur passionné pour rejoindre notre équipe produit. Vous travaillerez sur des projets innovants en React, Node.js et TypeScript.',
    source: 'LinkedIn',
    isHot: true,
  },
  {
    ...
    salary: '60K - 80K EUR',
    description: 'Pilotez la stratégie produit d\'une fintech en forte croissance. Vous définirez la roadmap et travaillerez avec des équipes tech de pointe.',
  ...
  },
  {
    ...
    salary: '50K - 70K EUR',
    description: 'Rejoignez notre laboratoire de recherche en IA. Vous développerez des modèles de ML pour résoudre des problèmes complexes en NLP et computer vision.',
    source: 'Indeed',
    isHot: true,
  },
  {
    ...
    salary: '48K - 68K EUR',
    description: 'Gérez notre infrastructure cloud multi-régions. Expertise requise en Kubernetes, Terraform, et CI/CD pipelines avec GitLab.',
    source: 'Monster',
    isHot: false,
  },
  {
    ...
    salary: '45K - 62K EUR',
    description: 'Concevez des expériences utilisateur exceptionnelles pour nos clients grands comptes. Maîtrise de Figma, design systems, et recherche utilisateur.',
...
export const GradientJobCard = React.forwardRef<HTMLDivElement, GradientJobCardProps>(
  ({ index, className }, ref) => {
...
export const JobsLimitReached = React.forwardRef<HTMLDivElement, JobsLimitReachedProps>(
