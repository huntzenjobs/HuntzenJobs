...
import { Upload, FileSearch, Sparkles, CheckCircle2, Loader2 } from 'lucide-react';
...
const steps: Step[] = [
  ...
  { id: 'extraction', label: 'Extraction du texte', icon: FileSearch, estimatedTime: '3-5s' },
  { id: 'analysis', label: 'Analyse IA', icon: Sparkles, estimatedTime: '8-12s' },
  { id: 'complete', label: 'Finalisation', icon: CheckCircle2, estimatedTime: '1s' },
];
  ...
  return (
    <div className="space-y-6">
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  ...
                  >
                    {isCompleted ? '✓' : isCurrent ? 'En cours...' : step.estimatedTime}
                  </span>
                </div>
                ...
                {isCurrent && (
                  <div className="mt-2 h-1.5 bg-blue-200 rounded-full overflow-hidden">
                    <motion.div
                      ...
                      animate={{ width: '100%' }}
                      transition={{
                        duration: stepNumber === 2 ? 4 : stepNumber === 3 ? 10 : 2,
                        ease: 'linear',
                      }}
                    />
                  </div>
      ...
      <div className="text-center text-sm text-gray-600 space-y-1">
        <p>
          Temps écoulé : <span className="font-semibold text-gray-900">{elapsedTime}s</span>
        </p>
