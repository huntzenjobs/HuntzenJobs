...
import { Users, Package, BarChart3, FileText, Gift, ShieldCheck, LayoutDashboard } from 'lucide-react'
...
export default function AdminNav() {
  ...
  const navItems = [
    ...
    { href: '/admin/logs',      label: 'Logs',         icon: FileText, badge: pendingWebhooks > 0 ? pendingWebhooks : undefined },
  ...
  return (
    <aside className="w-56 min-h-screen border-r bg-card flex flex-col shrink-0">
          ...
          return (
            ...
            >
              ...
              {item.badge !== undefined && (
                <span className={cn('text-xs font-bold px-1.5 py-0.5 rounded-full min-w-[1.25rem] text-center',
      ...
      <div className="p-3 border-t">
        <Link href="/jobs" className="flex items-center gap-3 px-3 py-2 rounded-md text-sm text-muted-foreground hover:text-foreground hover:bg-accent transition-colors">
