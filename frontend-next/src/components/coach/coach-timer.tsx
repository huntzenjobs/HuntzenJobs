...
export function CoachTimer({
  ...
  const sessionCutPopup = useConversionPopup("session_cut");
    ...
    <>
      ...
      >
        ...
        {colorState === "expired" ? (
          ...
          <Clock
            className={cn("flex-shrink-0", compact ? "size-4" : "size-5")}
          />
        )}
      ...
      <sessionCutPopup.PopupComponent />
    </>
  );
}
