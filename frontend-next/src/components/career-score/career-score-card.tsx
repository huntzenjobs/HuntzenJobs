...
export function CareerScoreCard({
  ...
  const t = useTranslations("careerScore");
  ...
  if (isLoading) {
    return (
      <div
        className={cn("rounded-xl border bg-card p-5 animate-pulse", className)}
      >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span
              className={cn(
                ...
                getScoreColor(score.total_score),
              )}
            >
              {score.total_score}
            </span>
