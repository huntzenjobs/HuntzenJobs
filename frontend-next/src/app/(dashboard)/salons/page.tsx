  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <motion.div
        ...
        className="flex items-start justify-between gap-4 bg-gradient-to-br from-white to-gray-50 p-8 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm mb-8"
      >
          ...
          <Button
            ...
            className={cn(
              ...
              showFilters
                ...
                : "border-gray-300 dark:border-gray-600 hover:border-[#00D9FF]",
            )}
          >
      ...
      {!loading && !error && (
        <motion.div
          ...
          className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400 mb-6"
        >
      ...
      <AnimatePresence>
        {showFilters && (
          ...
          >
            <ErrorBoundary
              fallback={
                <Card className="p-6 bg-red-50 dark:bg-red-900/30 border-red-200">
            ...
            >
              <Card className="border-2 border-gray-200 dark:border-gray-700 shadow-sm bg-white dark:bg-gray-800">
                <CardHeader className="bg-gradient-to-br from-white to-gray-50 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-center justify-between">
                    ...
                    {hasActiveFilters && (
                      <Button
                        ...
                        className="text-xs text-[#00D9FF] hover:text-black hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
                      >
      ...
      {error && (
        <motion.div
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
          className="mb-6 p-4 rounded-lg bg-red-50 dark:bg-red-900/30 border border-red-200 text-red-700 dark:text-red-400"
        >
      ...
      {loading && (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            ...
            >
              <Card className="animate-pulse border-2 border-gray-200 dark:border-gray-700">
                ...
                <CardContent className="space-y-4 pt-4">
                  ...
                  <div className="h-10 bg-gray-100 dark:bg-gray-700 rounded-lg w-full mt-4" />
                </CardContent>
              </Card>
            </motion.div>
          ))}
        ...
        >
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {events.length === 0 ? (
              ...
              >
                <Card className="border-2 border-dashed border-gray-300 dark:border-gray-600 bg-gradient-to-br from-gray-50 to-white">
...
function EventCard({ event, index }: { event: JobFair; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className="h-full flex flex-col hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 border-gray-200 dark:border-gray-700 hover:border-[#00D9FF]/50 bg-white dark:bg-gray-800 overflow-hidden">
        {/* Header - hauteur fixe */}
        <div className="bg-gradient-to-br from-white to-gray-50 border-b border-gray-200 dark:border-gray-700 p-4 h-[88px] flex items-center">
          <div className="flex items-start justify-between gap-3 w-full">
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-700 dark:text-gray-300 text-xs truncate">
                  {event.organizer}
                </span>
              </div>
            </div>
        ...
        <div className="flex-1 flex flex-col p-4 pt-3 space-y-2.5">
          ...
          {/* Location */}
          <div className="flex items-center gap-2 p-2 rounded-lg bg-gradient-to-r from-red-50 to-pink-50 border border-red-100 dark:border-red-800 h-14">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[9px] text-red-600 dark:text-red-400 font-medium uppercase tracking-wide leading-none mb-0.5">
                Lieu
              </p>
              <p className="text-xs font-semibold text-black line-clamp-1 leading-tight">
          ...
          {/* Time */}
          <div className="flex items-center gap-2 p-2 rounded-lg bg-gradient-to-r from-green-50 to-emerald-50 border border-green-100 dark:border-green-800 h-14">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[9px] text-green-600 dark:text-green-400 font-medium uppercase tracking-wide leading-none mb-0.5">
                Horaires
              </p>
              <p className="text-xs font-semibold text-black line-clamp-1 leading-tight">
                {event.time_start ? (
          ...
          <div className="flex flex-wrap gap-1.5 h-[52px] overflow-hidden">
            ...
            {event.sector !== "tous" && (
              <Badge
                variant="outline"
                className="text-[10px] capitalize font-medium border-gray-300 dark:border-gray-600 h-5 px-2"
              >
                {event.sector}
              </Badge>
            )}
            ...
            {event.companies_count && (
              <Badge
                variant="outline"
                className="text-[10px] font-medium border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 h-5 px-2"
              >
          ...
          {event.description ? (
            <p className="text-xs text-gray-600 dark:text-gray-400 line-clamp-2 leading-relaxed border-t border-gray-100 dark:border-gray-700 pt-2 h-[52px]">
