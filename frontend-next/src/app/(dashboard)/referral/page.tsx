...
export default function ReferralPage() {
  ...
  return (
    <PageGate featureFlag="page_referral">
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="rounded-xl border bg-card p-5">
          ...
          <div className="flex-1 text-xs font-mono bg-muted rounded-lg px-3 py-2.5 break-all text-muted-foreground">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <button
              ...
              className="px-3 py-2 rounded-lg bg-green-500 hover:bg-green-600 text-white text-sm font-medium transition-colors flex items-center justify-center gap-1.5"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-[#0A66C2] text-white text-sm font-medium hover:bg-[#004182] transition-colors"
            >
