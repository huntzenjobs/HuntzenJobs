      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {[
            ...
            >
              <Card className="border-2 border-gray-100 hover:border-[#00D9FF] hover:shadow-lg transition-all h-full">
                <CardContent className="pt-6">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#00D9FF] to-[#00C4EA] flex items-center justify-center mb-4 shadow-[#00D9FF]/20">
        ...
        >
          {/* Pricing Card */}
          <Card className="border-2 border-[#00D9FF] shadow-[#00D9FF]/20 overflow-hidden h-fit">
                ...
                <div className="grid gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      required
                      className={`border-gray-200 focus:border-[#00D9FF] ${touched.fullName && errors.fullName ? "border-red-500 focus:border-red-500" : ""}`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`pl-10 border-slate-300 focus:border-[#00D9FF] ${touched.email && errors.email ? "border-red-500 focus:border-red-500 focus:ring-red-500" : ""}`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`pl-10 border-slate-300 focus:border-[#00D9FF] ${touched.phone && errors.phone ? "border-red-500 focus:border-red-500 focus:ring-red-500" : ""}`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        id="preferredDate"
                        type="date"
                        className="pl-10 border-gray-300 focus:border-[#00D9FF]"
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      required
                      className={`border-slate-300 focus:border-[#00D9FF] ${touched.message && errors.message ? "border-red-500 focus:border-red-500 focus:ring-red-500" : ""}`}
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-[#00D9FF] to-[#00C4EA] text-white p-12 rounded-3xl text-center mt-12 shadow-[#00D9FF]/20"
        >
          <h3 className="text-3xl font-bold mb-4">{t("cta.title")}</h3>
          <p className="text-xl text-white/90 mb-6">{t("cta.spots")}</p>
          <Button
            size="lg"
            className="h-14 px-12 bg-white text-[#00D9FF] hover:bg-gray-50 font-bold transition-all duration-300 hover:scale-105"
            onClick={() => {
