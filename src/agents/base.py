...
class BaseAgent(ABC):
    ...
    async def chat(
        ...
        """
        Simple chat method with retry logic.
    ...
    def _parse_json(self, text: str) -> Optional[dict]:
        ...
        try:
            ...
            # Try a second approach: if LLM returned multiple objects, take the last one
            try:
...
class SubAgent:
    ...
    async def run(self, task: str, context: str = "") -> str:
        """
        Execute the sub-agent's task with retry logic.
